...
function demo() {
    const element = react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, "Hello world");
    const rendered = react_dom_server__WEBPACK_IMPORTED_MODULE_1__.renderToStaticMarkup(element);
    return rendered;
}
console.log(demo());
